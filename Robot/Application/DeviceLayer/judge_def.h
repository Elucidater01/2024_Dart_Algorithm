...
{ 
	...
	ID_game_robot_HP       					= 0x0003,//比赛机器人血量数据，3Hz发送
	...
	ID_dart_remaining_time					= 0x0105,//飞镖发射时间数据，3Hz
	...
	ID_ground_robot_position        = 0x020B,//地面机器人位置数据, 仅——哨兵机器人主控——发送，1Hz
	ID_radar_mark_data              = 0x020C,//雷达标记进度数据,仅——雷达机器人主控——发送， 1Hz
	...
	ID_keyboard_information               = 0x0304,//键盘、鼠标信息，通过——图传串口——发送， 30Hz
  ID_smallmap                           = 0x0305,//客户端小地图接收信息， 10Hz
  ID_custom_client_data                 = 0x0306,//自定义控制器与选手端交互数据，发送方触发——发送， 30Hz
  ID_map_sentry_data                    = 0x0307,//选手端小地图接收哨兵数据， 仅——云台手客户端——接收， 1Hz
};
//命令码枚举CMD_ID
//**************裁判系统各个信息的长度（单位/字节）**************************/
enum judge_data_length_t {
	...
	// 0x030x
	//LEN_ROBOT_INTERACTIVE_HEADER_DATA      = 128,
	//LEN_CONTROLLER_INTERACTIVE_HEADER_DATA = 30,
