...
osThreadId lowControlTaskHandle;
...
extern void StartlowControlTask(void const * argument);
extern void Startjudge_task(void const * argument);
...
void MX_FREERTOS_Init(void) {
  ...
  /* definition and creation of lowControlTask */
  osThreadDef(lowControlTask, StartlowControlTask, osPriorityLow, 0, 128);
  lowControlTaskHandle = osThreadCreate(osThread(lowControlTask), NULL);

  /* definition and creation of judge_task */
  osThreadDef(judge_task, Startjudge_task, osPriorityIdle, 0, 512);
